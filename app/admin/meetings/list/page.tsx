                  ...
                  {editingId === m.id ? (
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-2 pt-2">
                        <button disabled={!!deletingId} onClick={handleUpdate} className="bg-rose-600 text-white px-4 py-2 rounded text-sm font-semibold hover:bg-rose-700 transition disabled:opacity-50">Save Changes</button>
                        <button disabled={!!deletingId} onClick={() => setEditingId(null)} className="bg-zinc-100 text-zinc-700 px-4 py-2 rounded text-sm font-semibold hover:bg-zinc-200 transition disabled:opacity-50">Cancel</button>
                      </div>
                    </div>
                  ) : (
